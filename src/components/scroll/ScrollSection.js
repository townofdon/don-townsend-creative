...
const ScrollSection = ({
  ...
  scrollActions.forEach((scrollAction = {}) => {
    ...
    const passesCondition = typeof condition === "function" ? condition(pctProgressSection) : !!condition;
  ...
  const dynamicClassName = typeof className === "function" ? className(pctProgressSection) : className;

  const dynamicBackgroundImage =
    typeof backgroundImage === "function" ? backgroundImage(pctProgressSection) : backgroundImage;

  const dynamicBackgroundColor =
    typeof backgroundColor === "function" ? backgroundColor(pctProgressSection) : backgroundColor;
  ...
  return (
    ...
    >
      ...
      <ScrollSectionContent className={classNameContent}>
        {typeof render === "function" ? render({ ...scrollProps, ...calcs }) : children}
